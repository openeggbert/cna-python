"""Microsoft.Xna.Framework-compatible Python API backed by CNA."""
...
from _cna_native import require_available
...
class Vector2:
    """Two-dimensional vector matching the XNA public member names."""
...
class Game:
    """XNA-compatible game lifecycle backed by the native CNA engine."""

    def __init__(self) -> None:
        self._closed = False

    def Run(self) -> None:
        """Run the CNA-backed game loop when the ABI is available."""
        self._ensure_open()
        require_available()
