...
int main(void) {
    ...
    printf("VALUE CNA_SURFACE_FORMAT_COLOR %llu\n", (unsigned long long)(CNA_SURFACE_FORMAT_COLOR));
    printf("VALUE CNA_SURFACE_FORMAT_BGR565 %llu\n", (unsigned long long)(CNA_SURFACE_FORMAT_BGR565));
    printf("VALUE CNA_SURFACE_FORMAT_BGRA5551 %llu\n", (unsigned long long)(CNA_SURFACE_FORMAT_BGRA5551));
    printf("VALUE CNA_SURFACE_FORMAT_BGRA4444 %llu\n", (unsigned long long)(CNA_SURFACE_FORMAT_BGRA4444));
    printf("VALUE CNA_SURFACE_FORMAT_DXT1 %llu\n", (unsigned long long)(CNA_SURFACE_FORMAT_DXT1));
    printf("VALUE CNA_SURFACE_FORMAT_DXT3 %llu\n", (unsigned long long)(CNA_SURFACE_FORMAT_DXT3));
    printf("VALUE CNA_SURFACE_FORMAT_DXT5 %llu\n", (unsigned long long)(CNA_SURFACE_FORMAT_DXT5));
    printf("VALUE CNA_SURFACE_FORMAT_NORMALIZED_BYTE2 %llu\n", (unsigned long long)(CNA_SURFACE_FORMAT_NORMALIZED_BYTE2));
    printf("VALUE CNA_SURFACE_FORMAT_NORMALIZED_BYTE4 %llu\n", (unsigned long long)(CNA_SURFACE_FORMAT_NORMALIZED_BYTE4));
    printf("VALUE CNA_SURFACE_FORMAT_RGBA1010102 %llu\n", (unsigned long long)(CNA_SURFACE_FORMAT_RGBA1010102));
    printf("VALUE CNA_SURFACE_FORMAT_RG32 %llu\n", (unsigned long long)(CNA_SURFACE_FORMAT_RG32));
    printf("VALUE CNA_SURFACE_FORMAT_RGBA64 %llu\n", (unsigned long long)(CNA_SURFACE_FORMAT_RGBA64));
    printf("VALUE CNA_SURFACE_FORMAT_ALPHA8 %llu\n", (unsigned long long)(CNA_SURFACE_FORMAT_ALPHA8));
    printf("VALUE CNA_SURFACE_FORMAT_SINGLE %llu\n", (unsigned long long)(CNA_SURFACE_FORMAT_SINGLE));
    printf("VALUE CNA_SURFACE_FORMAT_VECTOR2 %llu\n", (unsigned long long)(CNA_SURFACE_FORMAT_VECTOR2));
    printf("VALUE CNA_SURFACE_FORMAT_VECTOR4 %llu\n", (unsigned long long)(CNA_SURFACE_FORMAT_VECTOR4));
    printf("VALUE CNA_SURFACE_FORMAT_HALF_SINGLE %llu\n", (unsigned long long)(CNA_SURFACE_FORMAT_HALF_SINGLE));
    printf("VALUE CNA_SURFACE_FORMAT_HALF_VECTOR2 %llu\n", (unsigned long long)(CNA_SURFACE_FORMAT_HALF_VECTOR2));
    printf("VALUE CNA_SURFACE_FORMAT_HALF_VECTOR4 %llu\n", (unsigned long long)(CNA_SURFACE_FORMAT_HALF_VECTOR4));
    printf("VALUE CNA_SURFACE_FORMAT_HDR_BLENDABLE %llu\n", (unsigned long long)(CNA_SURFACE_FORMAT_HDR_BLENDABLE));
    printf("VALUE CNA_SURFACE_FORMAT_COLOR_BGRA_EXT %llu\n", (unsigned long long)(CNA_SURFACE_FORMAT_COLOR_BGRA_EXT));
    printf("VALUE CNA_SURFACE_FORMAT_COLOR_SRGB_EXT %llu\n", (unsigned long long)(CNA_SURFACE_FORMAT_COLOR_SRGB_EXT));
    printf("VALUE CNA_SURFACE_FORMAT_DXT5_SRGB_EXT %llu\n", (unsigned long long)(CNA_SURFACE_FORMAT_DXT5_SRGB_EXT));
    printf("VALUE CNA_SURFACE_FORMAT_BC7_EXT %llu\n", (unsigned long long)(CNA_SURFACE_FORMAT_BC7_EXT));
