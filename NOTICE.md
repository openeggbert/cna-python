...
CNA-Python (`cna-python`) is licensed under the Microsoft Public License
(Ms-PL).

CNA-Python is a Python binding for [CNA](https://github.com/openeggbert/cna),
distributed separately from the native engine and intended to communicate with
it only through CNA's stable C ABI.
...
Ethan Lee and the MonoGame Team. CNA-Python does not include FNA source code.
