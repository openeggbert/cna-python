...
| `cluster-grid` (the cluster grid) | 15 | 0 | ACTIONABLE_LOCAL 15 |
| `clustered-forward-effect` (the clustered forward effect) | 29 | 0 | ACTIONABLE_LOCAL 29 |
...
| `cna_area_light_brdf_table_destroy` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the area-light BRDF table: the generated LTC table area lights sample) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_area_light_brdf_table_evaluate` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the area-light BRDF table: the generated LTC table area lights sample) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_area_light_brdf_table_get_generation_milliseconds` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the area-light BRDF table: the generated LTC table area lights sample) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_area_light_brdf_table_get_sample_count` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the area-light BRDF table: the generated LTC table area lights sample) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_area_light_brdf_table_get_size` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the area-light BRDF table: the generated LTC table area lights sample) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_area_light_brdf_table_get_texture` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the area-light BRDF table: the generated LTC table area lights sample) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_area_light_ext_init` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (area lights: the area-light value and its analytic shading terms) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_area_light_ext_is_valid` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (area lights: the area-light value and its analytic shading terms) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_area_light_shading_contribution` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (area lights: the area-light value and its analytic shading terms) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_area_light_shading_copy_shading_glsl` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (area lights: the area-light value and its analytic shading terms) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
...
| `cna_clustered_forward_effect_contribution` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the clustered forward effect: the forward effect that shades from a clustered light buffer) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_clustered_forward_effect_contribution_with_extensions` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the clustered forward effect: the forward effect that shades from a clustered light buffer) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_clustered_forward_effect_create` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the clustered forward effect: the forward effect that shades from a clustered light buffer) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_clustered_forward_effect_destroy` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the clustered forward effect: the forward effect that shades from a clustered light buffer) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_clustered_forward_effect_get_ambient` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the clustered forward effect: the forward effect that shades from a clustered light buffer) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
...
| `cna_clustered_forward_effect_get_metallic` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the clustered forward effect: the forward effect that shades from a clustered light buffer) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_clustered_forward_effect_get_opaque_frame` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the clustered forward effect: the forward effect that shades from a clustered light buffer) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_clustered_forward_effect_get_roughness` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the clustered forward effect: the forward effect that shades from a clustered light buffer) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_clustered_forward_effect_has_area_light` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the clustered forward effect: the forward effect that shades from a clustered light buffer) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_clustered_forward_effect_has_light_probe` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the clustered forward effect: the forward effect that shades from a clustered light buffer) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_clustered_forward_effect_is_supported` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the clustered forward effect: the forward effect that shades from a clustered light buffer) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_clustered_forward_effect_set_ambient` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the clustered forward effect: the forward effect that shades from a clustered light buffer) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_clustered_forward_effect_set_area_light` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the clustered forward effect: the forward effect that shades from a clustered light buffer) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_clustered_forward_effect_set_base_color` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the clustered forward effect: the forward effect that shades from a clustered light buffer) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_clustered_forward_effect_set_ior` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the clustered forward effect: the forward effect that shades from a clustered light buffer) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
...
| `cna_clustered_forward_effect_set_metallic` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the clustered forward effect: the forward effect that shades from a clustered light buffer) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_clustered_forward_effect_set_opaque_frame` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the clustered forward effect: the forward effect that shades from a clustered light buffer) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_clustered_forward_effect_set_roughness` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the clustered forward effect: the forward effect that shades from a clustered light buffer) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_clustered_forward_effect_volume_attenuation` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the clustered forward effect: the forward effect that shades from a clustered light buffer) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_clustered_light_assignment_adopt` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the cluster light assignment: which lights land in which cluster) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_clustered_light_assignment_assign` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the cluster light assignment: which lights land in which cluster) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_clustered_light_assignment_clear` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the cluster light assignment: which lights land in which cluster) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_clustered_light_assignment_copy_indices` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the cluster light assignment: which lights land in which cluster) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_clustered_light_assignment_copy_lights_in_cluster` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the cluster light assignment: which lights land in which cluster) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_clustered_light_assignment_copy_offsets` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the cluster light assignment: which lights land in which cluster) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_clustered_light_assignment_create` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the cluster light assignment: which lights land in which cluster) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_clustered_light_assignment_destroy` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the cluster light assignment: which lights land in which cluster) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_clustered_light_assignment_get_cluster_count` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the cluster light assignment: which lights land in which cluster) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_clustered_light_assignment_get_light_count` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the cluster light assignment: which lights land in which cluster) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_clustered_light_assignment_get_max_lights_per_cluster` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the cluster light assignment: which lights land in which cluster) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_clustered_light_assignment_get_total_reference_count` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the cluster light assignment: which lights land in which cluster) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_clustered_light_buffer_bind` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the clustered light upload buffer: the GPU buffer a clustered assignment uploads into) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_clustered_light_buffer_copy_light_lookup_glsl` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the clustered light upload buffer: the GPU buffer a clustered assignment uploads into) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_clustered_light_buffer_create` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the clustered light upload buffer: the GPU buffer a clustered assignment uploads into) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_clustered_light_buffer_destroy` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the clustered light upload buffer: the GPU buffer a clustered assignment uploads into) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_clustered_light_buffer_get_cluster_count` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the clustered light upload buffer: the GPU buffer a clustered assignment uploads into) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_clustered_light_buffer_get_light_count` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the clustered light upload buffer: the GPU buffer a clustered assignment uploads into) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_clustered_light_buffer_get_reference_count` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the clustered light upload buffer: the GPU buffer a clustered assignment uploads into) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_clustered_light_buffer_is_uploaded` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the clustered light upload buffer: the GPU buffer a clustered assignment uploads into) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_clustered_light_buffer_upload` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the clustered light upload buffer: the GPU buffer a clustered assignment uploads into) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_clustered_light_compute_assign` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the compute cluster assignment: the compute-shader path that assigns lights to clusters on the GPU) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_clustered_light_compute_copy_unsupported_reason` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the compute cluster assignment: the compute-shader path that assigns lights to clusters on the GPU) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_clustered_light_compute_create` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the compute cluster assignment: the compute-shader path that assigns lights to clusters on the GPU) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_clustered_light_compute_destroy` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the compute cluster assignment: the compute-shader path that assigns lights to clusters on the GPU) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_clustered_light_compute_get_stride` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the compute cluster assignment: the compute-shader path that assigns lights to clusters on the GPU) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_clustered_light_compute_has_overflowed` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the compute cluster assignment: the compute-shader path that assigns lights to clusters on the GPU) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_clustered_light_compute_is_supported` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the compute cluster assignment: the compute-shader path that assigns lights to clusters on the GPU) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_clustered_light_compute_used_compute` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the compute cluster assignment: the compute-shader path that assigns lights to clusters on the GPU) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_clustered_light_ext_init` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (clustered light values: the clustered light value structure) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_clustered_light_grid_cluster_bounds` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the cluster grid: the view-frustum cluster subdivision and its logarithmic depth slices) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_clustered_light_grid_cluster_index` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the cluster grid: the view-frustum cluster subdivision and its logarithmic depth slices) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_clustered_light_grid_create` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the cluster grid: the view-frustum cluster subdivision and its logarithmic depth slices) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_clustered_light_grid_destroy` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the cluster grid: the view-frustum cluster subdivision and its logarithmic depth slices) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_clustered_light_grid_get_cluster_count` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the cluster grid: the view-frustum cluster subdivision and its logarithmic depth slices) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_clustered_light_grid_get_far_plane` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the cluster grid: the view-frustum cluster subdivision and its logarithmic depth slices) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_clustered_light_grid_get_inverse_projection` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the cluster grid: the view-frustum cluster subdivision and its logarithmic depth slices) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_clustered_light_grid_get_near_plane` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the cluster grid: the view-frustum cluster subdivision and its logarithmic depth slices) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_clustered_light_grid_get_slice_count` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the cluster grid: the view-frustum cluster subdivision and its logarithmic depth slices) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_clustered_light_grid_get_tiles_x` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the cluster grid: the view-frustum cluster subdivision and its logarithmic depth slices) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_clustered_light_grid_get_tiles_y` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the cluster grid: the view-frustum cluster subdivision and its logarithmic depth slices) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_clustered_light_grid_has_projection` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the cluster grid: the view-frustum cluster subdivision and its logarithmic depth slices) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_clustered_light_grid_set_projection` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the cluster grid: the view-frustum cluster subdivision and its logarithmic depth slices) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_clustered_light_grid_slice_distance` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the cluster grid: the view-frustum cluster subdivision and its logarithmic depth slices) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_clustered_light_grid_slice_for_view_distance` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the cluster grid: the view-frustum cluster subdivision and its logarithmic depth slices) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_clustered_light_set_add` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the clustered light set: the collection of clustered light values a grid consumes) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_clustered_light_set_add_point` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the clustered light set: the collection of clustered light values a grid consumes) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_clustered_light_set_add_spot` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the clustered light set: the collection of clustered light values a grid consumes) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_clustered_light_set_clear` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the clustered light set: the collection of clustered light values a grid consumes) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_clustered_light_set_copy_bounds` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the clustered light set: the collection of clustered light values a grid consumes) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_clustered_light_set_copy_lights` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the clustered light set: the collection of clustered light values a grid consumes) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_clustered_light_set_create` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the clustered light set: the collection of clustered light values a grid consumes) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_clustered_light_set_destroy` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the clustered light set: the collection of clustered light values a grid consumes) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_clustered_light_set_get_at` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the clustered light set: the collection of clustered light values a grid consumes) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_clustered_light_set_get_bounds_at` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the clustered light set: the collection of clustered light values a grid consumes) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_clustered_light_set_get_count` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the clustered light set: the collection of clustered light values a grid consumes) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_clustered_light_set_is_empty` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the clustered light set: the collection of clustered light values a grid consumes) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_clustered_light_set_is_usable` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the clustered light set: the collection of clustered light values a grid consumes) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_clustered_light_set_remove_at` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the clustered light set: the collection of clustered light values a grid consumes) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_clustered_light_set_replace_at` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the clustered light set: the collection of clustered light values a grid consumes) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_clustered_shadow_policy_copy_selected` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the clustered shadow budget: which clustered lights get a shadow map inside a fixed budget) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_clustered_shadow_policy_create` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the clustered shadow budget: which clustered lights get a shadow map inside a fixed budget) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_clustered_shadow_policy_destroy` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the clustered shadow budget: which clustered lights get a shadow map inside a fixed budget) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_clustered_shadow_policy_get_budget` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the clustered shadow budget: which clustered lights get a shadow map inside a fixed budget) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
...
| `cna_clustered_shadow_policy_get_refused_count` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the clustered shadow budget: which clustered lights get a shadow map inside a fixed budget) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_clustered_shadow_policy_get_request_count` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the clustered shadow budget: which clustered lights get a shadow map inside a fixed budget) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_clustered_shadow_policy_get_score` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the clustered shadow budget: which clustered lights get a shadow map inside a fixed budget) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_clustered_shadow_policy_is_selected` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the clustered shadow budget: which clustered lights get a shadow map inside a fixed budget) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
| `cna_clustered_shadow_policy_reset` | engine_layer.h | ACTIONABLE_LOCAL | In the selected engine-layer extension family (the clustered shadow budget: which clustered lights get a shadow map inside a fixed budget) and reachable from cna.extensions.engine, but not yet imported. Every remaining route here is a task, not a decision. |
